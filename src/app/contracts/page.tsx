      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body">
            <h2 className="card-title text-sm text-base-content/60">총 계약</h2>
        ...
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body">
            <h2 className="card-title text-sm text-base-content/60">진행 중</h2>
        ...
        <div className="card bg-base-100 shadow-sm">
          <div className="card-body">
            <h2 className="card-title text-sm text-base-content/60">총 수익</h2>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div className="flex space-x-2">
                      <button className="btn btn-sm btn-outline">보기</button>
                      <button className="btn btn-sm btn-ghost">다운로드</button>
                    </div>
                  </td>
                </tr>
